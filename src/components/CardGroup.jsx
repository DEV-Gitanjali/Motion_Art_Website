...
const CardGroup = () => {
  return (
    <div>
        {/* this code for group of sub card design */}
       ...
       {/* this is the main group container  */}
       <div className='flex mt-10  flex-col  lg:flex-row md:flex-col justify-center items-center gap-6 md:gap-4 px-4 md:px-0'>
